      ...
      params: {
        ...
        created__range:
          filterParams.created !== null
            ? `${filterParams.created[0]} 00:00:00, ${filterParams.created[1]} 23:59:59`
            : null,
        modified__range:
          filterParams.modified !== null
            ? `${filterParams.modified[0]} 00:00:00, ${filterParams.modified[1]} 23:59:59`
            : null,
        page: page,
      },
    });
  ...
  return await http.get(baseRoute, {
    ...
    params: !!queryParams && {
      date_range: !queryParams.date_range
        ? null
        : `${queryParams.date_range[0]},${queryParams.date_range[1]}`,
      has_stock: queryParams.has_stock,
      invoice_types: !queryParams.invoice_types
        ? null

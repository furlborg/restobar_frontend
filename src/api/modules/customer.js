...
export async function getCustomerCredits(id, filters = {}) {
  return await http.get(`customers/${id}/credits/`, {
    params: {
      ...filters,
    },
  });
...
export async function payCustomerCredits(id, data) {
  const tillStore = useTillStore();
  return await http.post(`customers/${id}/pay_credits/`, {
    ...data,

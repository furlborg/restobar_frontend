      ...
      <div class="view-account-form">
        <n-form ref="formRef" label-placement="left" size="large" :model="formInline" :rules="rules">
          <n-form-item path="username">
            <n-input v-model:value="formInline.username" placeholder="Usuario" :disabled="loading"
              @input="formInline.username = $event.toUpperCase()" @keypress.enter="handleSubmit">
              <template #prefix>
          ...
          <n-form-item path="password">
            <n-input v-model:value="formInline.password" type="password" showPasswordOn="click" placeholder="Contraseña"
              :disabled="loading" @keypress.enter="handleSubmit">
              <template #prefix>
          ...
          <n-form-item>
            <n-button @click.prevent="handleSubmit" size="large" :loading="loading" color="#ff9068" block>
              Iniciar Sesión
            </n-button>
          </n-form-item>
        </n-form>
